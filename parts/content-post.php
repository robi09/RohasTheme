...
<article <?php post_class('post'); ?>>
	...
	<div class="post_content"<?php echo $full_width; ?>>
		...
		<div class="post_meta"><?php echo the_time(); ?> -  <?php printf( _nx( 'One Comment', '%1$s Comments', get_comments_number(), 'comments title', 'textdomain' ), number_format_i18n( get_comments_number() ) ); ?></div><!-- / .post_meta -->
		<p><?php the_excerpt(); ?></p>
